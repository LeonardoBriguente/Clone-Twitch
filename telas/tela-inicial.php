        ...
        <main>
            <div class="gallery" id="galeria">
                ...
                <div class="gallery-container">
                    <img class="gallery-item gallery-item-1" src="../images/gau.jpg" onclick="LiveCoringa()" data-index="1">
                    <img class="gallery-item gallery-item-2" src="../images/casimito.jpg" onclick="LiveCoringa()" data-index="2">
                    <img class="gallery-item gallery-item-3" src="../images/coringa.jpg" onclick="LiveCoringa()" data-index="3">
